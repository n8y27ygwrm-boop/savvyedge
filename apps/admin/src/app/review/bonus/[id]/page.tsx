...
export default async function BonusReviewDetailPage(
  props: BonusDetailPageProps,
) {
      ...
      <PageHeader
        ...
        breadcrumbs={[
          isPublicationCandidate
            ? { label: "Publication Queue", href: "/publication" }
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <GlassPanel padding="20px">
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: 14, fontWeight: 700, color: "#60a5fa" }}
                >
              ...
              <div>
                ...
                >
                  {bonus.valid_until
                    ? new Date(bonus.valid_until).toISOString().slice(0, 10)
                    : "No expiry date"}
                </div>
              </div>
            </div>
          ...
          <GlassPanel padding="20px">
            ...
            >
              Evidence Summary ({bonus.evidence_claims.length})
            </h3>
            ...
            {bonus.evidence_claims.length === 0 ? (
              ...
              >
                No evidence claims recorded for this bonus. Approval requires at
                least one active evidence claim.
              </div>
            ) : (
              <div
                ...
                {bonus.evidence_claims.map((claim) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Observed:{" "}
                        {new Date(claim.evidence.observed_at)
                          .toISOString()
                          .slice(0, 19)
                          .replace("T", " ")}
                      </span>
          ...
          <GlassPanel padding="20px">
            ...
            {bonus.workflow_events.length === 0 ? (
              <div style={{ color: "var(--admin-muted)", fontSize: 13 }}>
                No workflow audit events recorded.
              </div>
            ) : (
              <div style={{ overflowX: "auto" }}>
                ...
                >
                  <thead>
                    ...
                    >
                      <th style={{ padding: "8px 0", textAlign: "left" }}>
                        Event
                      </th>
                      <th style={{ padding: "8px 0", textAlign: "left" }}>
                        Actor
                  ...
                  <tbody>
                    {bonus.workflow_events.map((evt) => (
                      ...
                      >
                        ...
                        >
                          {evt.from_review_status || "—"} →{" "}
                          <strong style={{ color: "var(--admin-text)" }}>
                            {evt.to_review_status || "—"}
                          </strong>
                        </td>
                        <td
                          style={{
