...
export default async function CasinoReviewDetailPage(
  props: CasinoDetailPageProps,
) {
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <div style={{ gridColumn: "span 2" }}>
                ...
                <div>
                  {casino.licenses.length > 0 ? (
                    ...
                    <span style={{ color: "var(--admin-muted)", fontSize: 13 }}>
                      No active registered licenses found
                    </span>
                  )}
                </div>
              </div>
          ...
          <GlassPanel padding="20px">
            ...
            >
              Evidence Summary ({casino.evidence_claims.length})
            </h3>
            ...
            {casino.evidence_claims.length === 0 ? (
              ...
              >
                No evidence claims recorded. Approval requires at least one
                active evidence claim.
              </div>
            ) : (
              <div
